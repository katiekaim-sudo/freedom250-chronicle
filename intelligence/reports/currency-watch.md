...
2. a **regime-adjusted performance report card** for price stability, exchange
   order, external adjustment, current-payment usability and resilience; and
3. a **trade-transmission record** showing whether tariffs, invoicing,
   intervention, controls and financing actually move the balance of payments.

This is a cross-cut over the existing `TOKEN / STATE-LEDGER / METAL / WALL /
...
February 20, 2026 proclamation expressly used the deficit branch for covered
entries, subject to listed exemptions and Section 232 non-stacking, and set a
conditional July 24, 2026 end clock for goods entered for consumption or
...
- the 19 country members of the G20;
- the 17 unique currencies those countries use;
- the euro as one currency object plus separate France, Germany and Italy
  policy records and a euro-area shared-policy overlay;
- EU and African Union institutional context without inventing a separate AU
  currency;
- Articles I, IV, V, VI, VIII, XIV, XIX and XXX; the Integrated Surveillance
  Decision and relevant Selected Decisions;
- Article IV consultations, External Sector Reports, AREAER, WEO, BOP/IIP,
  reserves, exchange arrangements and official central-bank records;
- tariffs, quotas, export controls, invoice/payment/funding currency, customs
...
- treating every intervention as manipulation;
- treating a tariff announcement as a current-account improvement;
- treating local-currency payment as de-dollarization of funding, hedging,
  collateral, insurance or reserves;
- treating IMF purchases, SDR trades, central-bank swap lines and commercial FX
  swaps as one instrument.
...
The useful question is not “which currency went up?” It is:

> Did this monetary system preserve domestic and external order, permit
> adjustment and current payments, and carry its actual international load
> without shifting destructive costs into another lane?

That question lets tariffs, trade deals, sanctions, local-currency corridors,
reserve shifts, IMF financing and private payment rails enter one watch without
becoming one object.
