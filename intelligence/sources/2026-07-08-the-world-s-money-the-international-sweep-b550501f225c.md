...
> **Corrected September 6, 2026.** The Korea/Japan, gold-causality and recovered-report explanations below use the later July 20/31, August 4 and August 23 saved studies. Their source dates control. This does not refresh every other historical claim in this dated synthesis. Original captures remain in their event/source records.


# The World's Money — the International Sweep

*Sister note to Money From Below and the Money Machine deep dive. Above, below — and now abroad. The trilogy's third panel. Folded into the whole in [2026-07-08 - The Whole World's Money — the World Ring Folded In](../sources/2026-07-08-the-whole-world-s-money-the-world-ring-folded-in-72614fd1fcac.html).*

The question this sweep asked: if the two-poles reading is right — the belt building metal, the feds building the token — does the rest of the world show the same fight on the same clock? The later comparative research replaces that universal verdict with distinct institutional roles, monetary claims and operating states. The original two-poles framing remains the historical question, not a demonstrated classification of every economy. 162 dated events filed under **The world's money** (Crypto), tagged with the State Machine's own taxonomy raised to world scale: **TOKEN** (dollar/private stablecoin rails), **STATE-LEDGER** (CBDC), **METAL** (gold), **WALL** (bans, licenses, sanctions), **PLUMBING** (clearing, messaging, settlement).

## The six findings

**1. State-ledger projects have different legal and operating states.** The later July 20 claim audit replaces the blanket retreat account. Korea completed live Phase I transactions and began Hangang Phase II on March 18, 2026. Users held participating-bank deposit claims; BOK money was the separate wholesale settlement asset. Japan retained separate retail-CBDC design and tokenized-reserve experimentation. Europe’s retail digital-euro legislation, issuance decision and wholesale settlement/collateral work are separate objects. A pause, experiment, legal permission, scheduled product and live service do not establish the same state.
...
**3. Gold matters through ownership, accounts and financing.** The August 23 Gold BOP research shows material gold contributions to external accounts and financing, including Ghana. It does not isolate gold as the sole cause of the cedi’s 41% nominal appreciation. Export value is not automatically central-bank reserve capture, collateralized gold liquidity is not a gold export, and reserve revaluation is not a BOP transaction. The original reserve/custody observations require their own dates and transaction evidence; they do not establish one global gold-to-currency causal mechanism.
...
**5. Japan and Korea illustrate different bank-led claims and stages.** Japan’s effective reserve option allows up to 50% only for specified trust-beneficiary structures and qualifying short-dated sovereign bonds, subject to remaining-maturity, valuation and cure rules. It is not a blanket JGB backing or purchase requirement. JPYSC was issued by SBI Shinsei Trust Bank on June 24, 2026 inside a limited account-based perimeter. The three megabanks’ common-coin work remained preparation rather than demonstrated live issuance in the July 20 audit. Progmat’s roughly 40-institution repo initiative was a study; the $1.6T figure described the existing market, not committed on-chain volume. Korea’s deposit tokens and wholesale BOK settlement asset are a different architecture.

**6. Institutional adaptation must be tested by role and result.** BIS analysis, IMF surveillance and programs, G7/G20 coordination, national regulation and SWIFT operations are different kinds of activity. A policy recommendation, revised rule, network study or pilot does not establish a global institutional victory or defeat. The later coordination and financial-rails studies trace permission, implementation and end-user outcomes separately; they support comparing adaptation and institutional strain without assuming that every institution chose one state-ledger pole.
...
- **The autumn calendar:** digital ruble mandatory Sep 1 · SWIFT shared-ledger real-value H2 · Qivalis first issuance H2 · Pontes pilot end-Q3 · Basel review verdict late 2026 · BRICS Pay pilot end-2026 · BoE final stablecoin Code end-2026 · Progmat's tokenized-JGB repo study target, with production volume and finality unproved · G20 Miami December.
...
**Q4:** digital-euro trilogues (autumn); Qivalis first issuance; HKMA second license batch; Anchorpoint/HSBC HKD stablecoins live; BRICS Pay pilot; Basel review update; Vietnam's first exchange license + 6-month onshore migration clock; BNM ringgit-token clarity; G20 Miami (Dec); end-2026 Progmat JGB repo study target (not established production).
...
**Standing:** PBoC gold streak (~7th monthly); Russia's gold sales pace; Tether's next Venezuela freeze; the CNB bitcoin test portfolio; El Salvador's disputed BTC buys vs IMF reviews; whether China's Feb 2026 Notice becomes the approval channel for a state-blessed offshore CNH stablecoin; the never-published State Council stablecoin roadmap; Transatlantic Taskforce report hunt closed: July 14 recommendations were located by the August 4 study; public release followed the March 21 elapsed-date target by 115 days, but the date of any earlier report back to the finance ministries is unrecovered; no formal extension instrument was identified; Nigeria's naira-stablecoin task force report (overdue).
...
Previous sweep: 2026-07-08 - Money From Below — The State Sweep · Machine: The Money Machine

## Controlling correction sources

The later Workbench International Monetary Transition claim audit (July 20), Japan–Korea FX/stablecoin synthesis (July 31), U.S.–UK taskforce factual map (August 4), and Gold BOP claim audit (August 23) replace the earlier compressed explanations at the seams revised above.

September 7 taskforce clock clarification: public publication and delivery to the finance ministries are separate events. The [maintained taskforce map](../sources/transatlantic-taskforce-recommendations-factual-map-2026-08-04-24ec10449414.html) preserves this distinction; other historical claims above were not refreshed.
