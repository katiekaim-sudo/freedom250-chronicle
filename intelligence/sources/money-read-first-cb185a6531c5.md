...
[Banking Website Sweep — Source Document](../sources/banking-website-sweep-source-document-4cadeee6e9f4.html) — *what the banks say they are building, in their own words.*
Agreement Document Requests — Source Document — *what we could and could not get, and why. Read the misses.*
[The Fine Print — Factual Timeline](../sources/the-fine-print-factual-timeline-69fa51fe257d.html) — *the derived spine. Facts only.* · [The Crowd Cannot Assemble](../sources/the-crowd-cannot-assemble-34b267309649.html) — *the reading: the crowd is being taken apart.*

**4. Clearing and collateral — who stands in the middle**
[Federal Reserve Financial Constitution — Source Document](../sources/federal-reserve-financial-constitution-source-document-203118d0ec33.html) — *the audited
entity/accounting control: twelve Bank books, combined eliminations, two SOMA
allocation bases, service-revenue Banks, ISA, shared services, capital stock,
remittances and the deferred asset. Read this before treating an accounting
location as ownership or control.*
SEC Financial Reporting and Accounting Unit — Source Document — *the August
5 Enforcement unit, its 2012–2026 risk-model/task-force/group lineage, exact
OCA/Corp Fin/PCAOB boundaries, and the firewall between accounting enforcement
and open-ledger adoption.*
DTCC Timeline — Jan 2025 to Jul 2026 — *raw DTCC event data. **Unaudited** — pull the filing before you lean on a row.*
[Clearing-House Transition — Factual Timeline](../sources/clearing-house-transition-factual-timeline-6595f41e3831.html) — *the canonical facts, each with a source link. This wins over the raw sweep.*
DTCC Atomic Settlement Liquidity Stress Test — Source Document — *the DTC tokenization/Collateral AppChain architecture, July cash-leg boundary, and DTC/NSCC/FICC cash-plus-securities liquidity model.*
...
Treasury control plane across international finance, payment/accounting
centralization, housing, tax eligibility, Gold Card funds and digital-asset
adjacency; preserves the line between institutional repurposing and IMF/Fed
exit, and between a Treasury account and a monetary reserve.*
CLARITY Act — July 22 Senate Substitute — *the 616-page combined Senate object: SEC/CFTC market structure, bank authority, stablecoin rewards, custody, software/self-custody shields, DCAC and lawful-order controls. Public draft, not filed amendment or law.*
PACE Act — Legal and Operational Map — *the proposed two-gate federal route, narrow reserve account and no automatic master account; read the map for current legal state.*
American Reserve Modernization Act — Legal Map — *the proposed statutory SBR/stockpile architecture; read the map for current legal state and operating-authority boundary.*
