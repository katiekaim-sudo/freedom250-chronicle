...
The company census must not stop at the best-known names. The OCC's public digital-asset application list showed a much wider 2026 queue, including PAYO Digital Bank, zerohash national trust bank, Revolut Bank US, EDX Trust, Bastion Platforms National Trust Company, Lorum National Trust Bank, OpenReserve Bank, Agora National Trust Bank, Catena Trust Bank, Payward National Trust Company, and CBW Bank. **World Liberty is no longer merely a pending queue item:** OCC Corporate Decision 1385, dated August 14, 2026, granted preliminary conditional approval to the proposed World Liberty Trust Company, N.A. The proposed bank plans to assume USD1 issuance and reserve assets/liabilities from BitGo after establishment, but it cannot commence business until preopening requirements and final approval are satisfied; the letter also says it does not currently plan to seek a Federal Reserve master account. [OCC digital-asset licensing applications](https://www.occ.gov/topics/charters-and-licensing/digital-assets-licensing-applications/index-digital-assets-licensing-applications.html); [OCC Corporate Decision 1385](https://www.occ.treas.gov/topics/charters-and-licensing/interpretations-and-decisions/2026/cd1385.pdf)
