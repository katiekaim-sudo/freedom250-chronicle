...
- [COMMITTEE_RESEARCH_EXECUTION_PLAN.md](../sources/committee-research-execution-plan-da76c3533006.html) — canonical five-layer operating plan,
  agent model, merge gates, and completion standard.
- [COMMITTEE_RESEARCH_STATUS_2026-07-28.md](../sources/committee-research-status-2026-07-28-de8bfb1cadf5.html) — current exact post-Wave-4 state,
...
- [COMMITTEE_ACTIVITY_SYNTHESIS_2026-07-26.md](../sources/committee-activity-synthesis-2026-07-26-05a5acfd2b85.html) — merged read-only analysis of
...
- INTELLIGENCE_COMMITTEE_SOURCE_MANIFEST.md — human source and evidence-tier
  router.
- [COMMITTEE_STORY_WATCHBOARD.md](../sources/committee-story-watchboard-771eeddb8cac.html) — dated triggers, falsifiers, and source
  routes.
...
Open the official transcripts behind these saved hearing studies.

- On-chain tools, April 9, 2025: [formal transcript (PDF)](https://docs.house.gov/meetings/AG/AG22/20250409/118098/HHRG-119-AG22-Transcript-20250409.pdf); saved analysis.
- CFTC at 50, March 25, 2025: [formal transcript (PDF)](https://docs.house.gov/meetings/AG/AG00/20250325/118038/HHRG-119-AG00-Transcript-20250325-U1.pdf); saved analysis.
- Intelligence-committee source manifest — official event, transcript and witness-material routes.
